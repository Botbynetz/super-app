...
export const seedProductTemplates = () => 
  api.post('/ai/seed-product-templates');
...
export const updateChatbot = (chatbotId, updates) => 
  api.put(`/ai/chatbot/${chatbotId}`, updates);

export const sendChatbotMessage = (chatbotId, message) => 
  api.post(`/ai/chatbot/${chatbotId}/message`, { message });

export const getChatbotStats = (chatbotId) => 
  api.get(`/ai/chatbot/${chatbotId}/stats`);

// AI CV Generator
export const seedCVTemplates = () => 
  api.post('/ai/seed-cv-templates');
...
export const calculateFreelancerScore = (userId) => 
  api.post('/ai/calculate-freelancer-score', { userId });

export const getFreelancerRankings = (skill, limit) => 
  api.get('/ai/freelancer-rankings', { params: { skill, limit } });

// AI Smart Recommendations
export const updateUserPreferences = (interests, preferredEventTypes, preferredContentTypes, preferredStreamCategories) => 
  api.post('/ai/update-preferences', { interests, preferredEventTypes, preferredContentTypes, preferredStreamCategories });
